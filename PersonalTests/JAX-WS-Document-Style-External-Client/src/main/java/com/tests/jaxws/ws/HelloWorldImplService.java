 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://ws.jaxws.tests.com/", wsdlLocation = "http://localhost:9999/ws/hello")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://ws.jaxws.tests.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/ws/hello");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://ws.jaxws.tests.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.jaxws.tests.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
