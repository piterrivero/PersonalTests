...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://ws.jaxws.tests.com/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://ws.jaxws.tests.com/", "getHelloWorldAsString");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaxws.tests.com/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaxws.tests.com/", name = "getHelloWorldAsString")
